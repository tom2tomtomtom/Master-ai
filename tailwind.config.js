  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'ai-glow': '0 0 20px rgba(0, 102, 255, 0.3)',
        'ai-glow-lg': '0 0 40px rgba(0, 102, 255, 0.2)',
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-mesh': 'linear-gradient(45deg, #667eea 0%, #764ba2 50%, #f093fb 100%)',
